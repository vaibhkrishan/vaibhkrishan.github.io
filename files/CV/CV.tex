...
\begin{tabular}{p{2.5cm}|p{11cm}l}
  \href{https://eccc.weizmann.ac.il/report/2024/074/#revision1}{{\bf ITCS 2026}} & Lower Bounds and Separations for Torus Polynomials \\
                                                                  & with S. Vishwanathan \\
                                                                  & The 17\textsuperscript{th} Innovations in Theoretical Computer Science Conference, 2026 (to appear). \\
  \\
...
\begin{itemize}
  ...
  \item TA duty for complexity theory, design and analysis of algorithms, and combinatorics.
\end{itemize}
...
\begin{itemize}
  ...
  \item As Quantitative Developer in AlphaGrep from June `16-July 17 and Jan `14-May `15.
